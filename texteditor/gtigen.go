...
var DiffTextEditorType = gti.AddType(&gti.Type{Name: "goki.dev/texteditor.DiffTextEditor", IDName: "diff-text-editor", Doc: "DiffTextEditor supports double-click based application of edits from one\nbuffer to the other.", Embeds: []gti.Field{{Name: "Editor"}}, Instance: &DiffTextEditor{}})

// NewDiffTextEditor adds a new [DiffTextEditor] with
// the given name to the given parent:
...
func (t *DiffTextEditor) SetStackTop(v int) *DiffTextEditor { t.StackTop = v; return t }

// SetPlaceholder sets the [DiffTextEditor.Placeholder]
func (t *DiffTextEditor) SetPlaceholder(v string) *DiffTextEditor { t.Placeholder = v; return t }
...
func (t *Editor) SetPlaceholder(v string) *Editor { t.Placeholder = v; return t }
...
func (t *Editor) SetStackTop(v int) *Editor { t.StackTop = v; return t }

// TwinEditorsType is the [gti.Type] for [TwinEditors]
var TwinEditorsType = gti.AddType(&gti.Type{Name: "goki.dev/texteditor.TwinEditors", IDName: "twin-editors", Doc: "TwinEditors presents two side-by-side [Editor]s in [gi.Splits]\nthat scroll in sync with each other.", Embeds: []gti.Field{{Name: "Splits"}}, Fields: []gti.Field{{Name: "BufA", Doc: "textbuf for A"}, {Name: "BufB", Doc: "textbuf for B"}}, Instance: &TwinEditors{}})

// NewTwinEditors adds a new [TwinEditors] with
// the given name to the given parent:
...
func (t *TwinEditors) SetStackTop(v int) *TwinEditors { t.StackTop = v; return t }
