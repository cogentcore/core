...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/texteditor/histyle.Value", IDName: "value", Doc: "Value represents a [core.HiStyleName] with a button.", Embeds: []gti.Field{{Name: "ValueBase"}}})
