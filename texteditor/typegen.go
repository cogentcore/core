...
func (t *spellCheck) SetSrcLn(v int) *spellCheck { t.srcLn = v; return t }

// SetSrcCh sets the [Spell.SrcCh]:
// character position in source that spelling is operating on (start of word to be corrected)
func (t *spellCheck) SetSrcCh(v int) *spellCheck { t.srcCh = v; return t }

// SetSuggest sets the [Spell.Suggest]:
// list of suggested corrections
func (t *spellCheck) SetSuggest(v ...string) *spellCheck { t.suggest = v; return t }

// SetStage sets the [Spell.Stage]:
// Stage is the [PopupStage] associated with the [spellState]
func (t *spellCheck) SetStage(v *core.Stage) *spellCheck { t.stage = v; return t }
