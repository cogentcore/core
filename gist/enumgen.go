...
var _ColorSchemeTypesValues = []ColorSchemeTypes{0, 1}

// ColorSchemeTypesN is the highest valid value
// for type ColorSchemeTypes, plus one.
const ColorSchemeTypesN ColorSchemeTypes = 2

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the enumgen command to generate them again.
func _ColorSchemeTypesNoOp() {
	var x [1]struct{}
	_ = x[ColorSchemeLight-(0)]
	_ = x[ColorSchemeDark-(1)]
}

var _ColorSchemeTypesNameToValueMap = map[string]ColorSchemeTypes{
	`ColorSchemeLight`: 0,
	`colorschemelight`: 0,
	`ColorSchemeDark`:  1,
	`colorschemedark`:  1,
...
var _ColorSchemeTypesDescMap = map[ColorSchemeTypes]string{
	0: `ColorSchemeLight is a light color scheme`,
	1: `ColorSchemeDark is a dark color scheme`,
}

var _ColorSchemeTypesMap = map[ColorSchemeTypes]string{
	0: `ColorSchemeLight`,
	1: `ColorSchemeDark`,
}

// String returns the string representation
// of this ColorSchemeTypes value.
func (i ColorSchemeTypes) String() string {
	if str, ok := _ColorSchemeTypesMap[i]; ok {
		return str
	}
	return strconv.FormatInt(int64(i), 10)
}

// SetString sets the ColorSchemeTypes value from its
// string representation, and returns an
// error if the string is invalid.
func (i *ColorSchemeTypes) SetString(s string) error {
	if val, ok := _ColorSchemeTypesNameToValueMap[s]; ok {
		*i = val
		return nil
	}
	if val, ok := _ColorSchemeTypesNameToValueMap[strings.ToLower(s)]; ok {
		*i = val
		return nil
	}
	return errors.New(s + " is not a valid value for type ColorSchemeTypes")
}
...
func (i *ColorSchemeTypes) SetInt64(in int64) {
	*i = ColorSchemeTypes(in)
}

// Desc returns the description of the ColorSchemeTypes value.
func (i ColorSchemeTypes) Desc() string {
	if str, ok := _ColorSchemeTypesDescMap[i]; ok {
		return str
	}
	return i.String()
}

// ColorSchemeTypesValues returns all possible values
// for the type ColorSchemeTypes.
func ColorSchemeTypesValues() []ColorSchemeTypes {
	return _ColorSchemeTypesValues
}

// Values returns all possible values
// for the type ColorSchemeTypes.
func (i ColorSchemeTypes) Values() []enums.Enum {
	res := make([]enums.Enum, len(_ColorSchemeTypesValues))
	for i, d := range _ColorSchemeTypesValues {
		res[i] = d
	}
	return res
}
...
// IsValid returns whether the value is a
// valid option for type ColorSchemeTypes.
func (i ColorSchemeTypes) IsValid() bool {
	_, ok := _ColorSchemeTypesMap[i]
	return ok
}
...
var _ColorSourcesValues = []ColorSources{0, 1, 2}

// ColorSourcesN is the highest valid value
// for type ColorSources, plus one.
const ColorSourcesN ColorSources = 3

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the enumgen command to generate them again.
func _ColorSourcesNoOp() {
	var x [1]struct{}
	_ = x[SolidColor-(0)]
...
var _ColorSourcesNameToValueMap = map[string]ColorSources{
	`SolidColor`:     0,
	`solidcolor`:     0,
	`LinearGradient`: 1,
	`lineargradient`: 1,
...
var _ColorSourcesDescMap = map[ColorSources]string{
	0: ``,
	1: ``,
	2: ``,
}

var _ColorSourcesMap = map[ColorSources]string{
	0: `SolidColor`,
	1: `LinearGradient`,
	2: `RadialGradient`,
}
...
// String returns the string representation
// of this ColorSources value.
func (i ColorSources) String() string {
	if str, ok := _ColorSourcesMap[i]; ok {
		return str
	}
	return strconv.FormatInt(int64(i), 10)
}

// SetString sets the ColorSources value from its
// string representation, and returns an
// error if the string is invalid.
func (i *ColorSources) SetString(s string) error {
	if val, ok := _ColorSourcesNameToValueMap[s]; ok {
		*i = val
		return nil
	}
	if val, ok := _ColorSourcesNameToValueMap[strings.ToLower(s)]; ok {
		*i = val
		return nil
	}
	return errors.New(s + " is not a valid value for type ColorSources")
}
...
func (i ColorSources) Desc() string {
	if str, ok := _ColorSourcesDescMap[i]; ok {
		return str
	}
	return i.String()
}

// ColorSourcesValues returns all possible values
// for the type ColorSources.
func ColorSourcesValues() []ColorSources {
	return _ColorSourcesValues
}

// Values returns all possible values
// for the type ColorSources.
func (i ColorSources) Values() []enums.Enum {
	res := make([]enums.Enum, len(_ColorSourcesValues))
	for i, d := range _ColorSourcesValues {
		res[i] = d
	}
	return res
}
...
// IsValid returns whether the value is a
// valid option for type ColorSources.
func (i ColorSources) IsValid() bool {
	_, ok := _ColorSourcesMap[i]
	return ok
}
...
var _GradientPointsValues = []GradientPoints{0, 1, 2, 3}

// GradientPointsN is the highest valid value
// for type GradientPoints, plus one.
const GradientPointsN GradientPoints = 4

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the enumgen command to generate them again.
func _GradientPointsNoOp() {
	var x [1]struct{}
	_ = x[GpX1-(0)]
	_ = x[GpY1-(1)]
	_ = x[GpX2-(2)]
...
var _GradientPointsNameToValueMap = map[string]GradientPoints{
	`GpX1`: 0,
	`gpx1`: 0,
	`GpY1`: 1,
	`gpy1`: 1,
...
var _GradientPointsDescMap = map[GradientPoints]string{
	0: ``,
	1: ``,
	2: ``,
	3: ``,
...
var _GradientPointsMap = map[GradientPoints]string{
	0: `GpX1`,
	1: `GpY1`,
	2: `GpX2`,
	3: `GpY2`,
...
// String returns the string representation
// of this GradientPoints value.
func (i GradientPoints) String() string {
	if str, ok := _GradientPointsMap[i]; ok {
		return str
	}
	return strconv.FormatInt(int64(i), 10)
}

// SetString sets the GradientPoints value from its
// string representation, and returns an
// error if the string is invalid.
func (i *GradientPoints) SetString(s string) error {
	if val, ok := _GradientPointsNameToValueMap[s]; ok {
		*i = val
		return nil
	}
	if val, ok := _GradientPointsNameToValueMap[strings.ToLower(s)]; ok {
		*i = val
		return nil
	}
	return errors.New(s + " is not a valid value for type GradientPoints")
}
...
func (i GradientPoints) Desc() string {
	if str, ok := _GradientPointsDescMap[i]; ok {
		return str
	}
	return i.String()
}

// GradientPointsValues returns all possible values
// for the type GradientPoints.
func GradientPointsValues() []GradientPoints {
	return _GradientPointsValues
}

// Values returns all possible values
// for the type GradientPoints.
func (i GradientPoints) Values() []enums.Enum {
	res := make([]enums.Enum, len(_GradientPointsValues))
	for i, d := range _GradientPointsValues {
		res[i] = d
	}
	return res
}
...
// IsValid returns whether the value is a
// valid option for type GradientPoints.
func (i GradientPoints) IsValid() bool {
	_, ok := _GradientPointsMap[i]
	return ok
}
