...
func init() {
	Symbols["cogentcore.org/core/styles/styles"] = map[string]reflect.Value{
		...
		"ParseDashesString":            reflect.ValueOf(styles.ParseDashesString),
		...
		"StyleBorderFuncs":             reflect.ValueOf(&styles.StyleBorderFuncs).Elem(),
		...
		"StylePaintFuncs":              reflect.ValueOf(&styles.StylePaintFuncs).Elem(),
		"StylePropertiesXML":           reflect.ValueOf(styles.StylePropertiesXML),
		"StyleSetError":                reflect.ValueOf(styles.StyleSetError),
		"StyleShadowFuncs":             reflect.ValueOf(&styles.StyleShadowFuncs).Elem(),
		"StyleStrokeFuncs":             reflect.ValueOf(&styles.StyleStrokeFuncs).Elem(),
		"StyleStyleFuncs":              reflect.ValueOf(&styles.StyleStyleFuncs).Elem(),
		"StyleTextFuncs":               reflect.ValueOf(&styles.StyleTextFuncs).Elem(),
		...
		"StyleFunc":        reflect.ValueOf((*styles.StyleFunc)(nil)),
