...
func init() {
	Symbols["cogentcore.org/core/tensor/tensor"] = map[string]reflect.Value{
		...
		"NewFloat64FromSlice":      reflect.ValueOf(tensor.NewFloat64FromSlice),
		...
		"NewIntFromSlice":          reflect.ValueOf(tensor.NewIntFromSlice),
		...
		"NewStringTensorFromSlice": reflect.ValueOf(tensor.NewStringTensorFromSlice),
		...
		"SprintIndexed":            reflect.ValueOf(tensor.SprintIndexed),
