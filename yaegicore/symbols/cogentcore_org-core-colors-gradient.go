...
func init() {
	Symbols["cogentcore.org/core/colors/gradient/gradient"] = map[string]reflect.Value{
		...
		"FixGradientStops":       reflect.ValueOf(gradient.FixGradientStops),
		"FromAny":                reflect.ValueOf(gradient.FromAny),
		"FromString":             reflect.ValueOf(gradient.FromString),
		"GradientDegToSides":     reflect.ValueOf(&gradient.GradientDegToSides).Elem(),
		...
		"ParseColorStop":         reflect.ValueOf(gradient.ParseColorStop),
		"RayCircleIntersectionF": reflect.ValueOf(gradient.RayCircleIntersectionF),
		"ReadFraction":           reflect.ValueOf(gradient.ReadFraction),
		"ReadGradAttr":           reflect.ValueOf(gradient.ReadGradAttr),
