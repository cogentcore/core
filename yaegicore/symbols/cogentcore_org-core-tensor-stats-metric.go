...
func init() {
	Symbols["cogentcore.org/core/tensor/stats/metric/metric"] = map[string]reflect.Value{
		...
		"AbsOut":                     reflect.ValueOf(metric.AbsOut),
		...
		"EuclideanBinTolOut":         reflect.ValueOf(metric.EuclideanBinTolOut),
		"EuclideanOut":               reflect.ValueOf(metric.EuclideanOut),
		...
		"InnerProductOut":            reflect.ValueOf(metric.InnerProductOut),
