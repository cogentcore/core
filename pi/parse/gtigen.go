...
// (e.g., expr, stmt, etc)
// These nodes are generated by the parse.Rule's by matching tokens
func NewAst(parent ki.Node, name ...string) *Ast {
...
func (t *Rule) SetFiTokMap(v map[string]*Rule) *Rule { t.FiTokenMap = v; return t }

// SetFiTokElseIndex sets the [Rule.FiTokElseIndex]:
// for FirstTokenMap, the start of the else cases not covered by the map
func (t *Rule) SetFiTokElseIndex(v int) *Rule { t.FiTokenElseIndex = v; return t }

// SetExclKeyIndex sets the [Rule.ExclKeyIndex]:
// exclusionary key index -- this is the token in Rules that we need to exclude matches for using ExclFwd and ExclRev rules
func (t *Rule) SetExclKeyIndex(v int) *Rule { t.ExclKeyIndex = v; return t }
