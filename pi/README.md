...
[![Go Report Card](https://goreportcard.com/badge/goki.dev/pi)](https://goreportcard.com/report/goki.dev/pi)
[![Go Reference](https://pkg.go.dev/badge/goki.dev/pi.svg)](https://pkg.go.dev/goki.dev/pi)
[![CI](https://goki.dev/pi/actions/workflows/ci.yml/badge.svg)](https://goki.dev/pi/actions/workflows/ci.yml)
[![Codecov](https://codecov.io/gh/goki/pi/branch/master/graph/badge.svg?token=Hw5cInAxY3)](https://codecov.io/gh/goki/pi)

See the [Wiki](https://goki.dev/pi/wiki) for more detailed docs, and [Google Groups goki-gi](https://groups.google.com/forum/#!forum/goki-gi) emailing list.
...
See the [complete grammar for Go](https://goki.dev/pi/blob/master/langs/golang/go.pig) for everything, including the lexer rules (at the top).
...
Please see the [Wiki](https://goki.dev/pi/wiki) for more detailed docs, discussion, etc.
