...
func main() {
	...
	opts.SearchUp = true
	grease.Run(opts, &config.Config{}, packman.Build, packman.GenerateColorScheme, generate.Generate, tools.Init, packman.Install, packman.Log, packman.Release, packman.GetVersion, packman.SetVersion, packman.UpdateVersion)
}
