...
func main() {
	...
	opts.SearchUp = true
	grease.Run(opts, &config.Config{}, packman.Build, generate.Generate, tools.Init, packman.Install, packman.Log, packman.Release, packman.GetVersion, packman.SetVersion, packman.UpdateVersion)
}
