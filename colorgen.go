...
// colorSchemesPreamble is the string located
// at the top of the colorschemes.go file
const colorSchemesPreamble = `// Code generated by "goki colorgen"; DO NOT EDIT
...
// at the given destination file path.
func GenerateColorScheme(src, dst string) error {
	d, err := GetColorSchemeData(src)
	if err != nil {
		return fmt.Errorf("GenerateColorScheme: error getting color scheme data: %w", err)
	}

	buf := bytes.NewBufferString(colorSchemesPreamble)
