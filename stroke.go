...
var KiT_LineCap = ki.KiEnums.AddEnumAltLower(LineCapButt, "LineCap", int64(LineCapN))
...
var KiT_LineJoin = ki.KiEnums.AddEnumAltLower(LineJoinMiter, "LineJoin", int64(LineJoinN))
