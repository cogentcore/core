...
A **table** is a [[widget]] that allows you to display a slice of structs to users as a table and have them edit it ([[doc:core.Table]]). Users can use [[context menu]]s and [[events#drag-and-drop]] to add, remove, and move rows. Also, users can sort the table by clicking on columns.
