...
func (dl *DirLight) ViewDir(viewMat *math32.Mat4) math32.Vec3 {
...
func (pl *PointLight) ViewPos(viewMat *math32.Mat4) math32.Vec3 {
...
func (sl *SpotLight) LookAtOrigin() {
	sl.LookAt(math32.Vec3{}, math32.V3(0, 1, 0))
}
...
func (sc *Scene) ConfigLights() {
	...
	for _, ltkv := range sc.Lights.Order {
		lt := ltkv.Value
		clr := math32.NewVec3Color(lt.Color()).MulScalar(lt.Lumens()).SRGBToLinear()
		switch l := lt.(type) {
		case *AmbientLight:
