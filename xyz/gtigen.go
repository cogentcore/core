...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.RenderClasses", IDName: "render-classes", Doc: "RenderClasses define the different classes of rendering", Directives: []gti.Directive{{Tool: "enums", Directive: "enum", Args: []string{"-trimprefix", "RClass"}}}})
