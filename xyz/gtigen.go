...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.LightColors", IDName: "light-colors", Doc: "LightColors are standard light colors for different light sources", Directives: []gti.Directive{{Tool: "enums", Directive: "enum"}}})
...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.GenMesh", IDName: "gen-mesh", Doc: "GenMesh is a generic, arbitrary Mesh, storing its values", Embeds: []gti.Field{{Name: "MeshBase"}}, Fields: []gti.Field{{Name: "Vtx"}, {Name: "Norm"}, {Name: "Tex"}, {Name: "Clr"}, {Name: "Idx"}}})
...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.NodeFlags", IDName: "node-flags", Doc: "NodeFlags extend ki.Flags to hold 3D node state", Directives: []gti.Directive{{Tool: "enums", Directive: "bitflag"}}})
...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.RenderClasses", IDName: "render-classes", Doc: "RenderClasses define the different classes of rendering", Directives: []gti.Directive{{Tool: "enums", Directive: "enum", Args: []string{"-trim-prefix", "RClass"}}}})
...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.TextureGi2D", IDName: "texture-gi-2-d", Doc: "TextureGi2D is a dynamic texture material driven by a gi.Viewport2D viewport\nanything rendered to the viewport will be projected onto the surface of any\nsolid using this texture.", Embeds: []gti.Field{{Name: "TextureBase"}}})
