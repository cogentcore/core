...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.MeshName", IDName: "mesh-name", Doc: "MeshName is a mesh name -- provides an automatic gui chooser for meshes.\nUsed on Solid to link to meshes by name."})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.Mesh", IDName: "mesh", Doc: "Mesh parameterizes the mesh-based shape used for rendering a Solid.\nOnly indexed triangle meshes are supported.\nAll Mesh's must know in advance the number of vertex and index points\nthey require, and the SetVerticies method operates on data from the\nvgpu staging buffer to set the relevant data post-allocation.\nThe vgpu vshape library is used for all basic shapes, and it follows\nthis same logic.\nPer-vertex Color is optional, as is the ability to update the data\nafter initial SetVerticies call (default is to do nothing)."})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.MeshBase", IDName: "mesh-base", Doc: "MeshBase provides the core implementation of Mesh interface", Directives: []gti.Directive{{Tool: "gti", Directive: "add", Args: []string{"-setters"}}}, Fields: []gti.Field{{Name: "Nm", Doc: "name of mesh -- meshes are linked to Solids by name so this matters"}, {Name: "NVtx", Doc: "number of vertex points, as mat32.Vec3 -- always includes mat32.Vec3 normals and mat32.Vec2 texture coordinates -- only valid after Sizes() has been called"}, {Name: "NIndex", Doc: "number of indexes, as mat32.ArrayU32 -- only valid after Sizes() has been called"}, {Name: "Color", Doc: "has per-vertex colors, as mat32.Vec4 per vertex"}, {Name: "Dynamic", Doc: "if true, this mesh changes frequently -- otherwise considered to be static"}, {Name: "Trans", Doc: "set to true if color has transparency -- not worth checking manually"}, {Name: "BBox", Doc: "computed bounding-box and other gross solid properties"}, {Name: "BBoxMu", Doc: "mutex on bbox access"}}})
...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.GenMesh", IDName: "gen-mesh", Doc: "GenMesh is a generic, arbitrary Mesh, storing its values", Embeds: []gti.Field{{Name: "MeshBase"}}, Fields: []gti.Field{{Name: "Vtx"}, {Name: "Norm"}, {Name: "Tex"}, {Name: "Clr"}, {Name: "Index"}}})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.Node", IDName: "node", Doc: "Node is the common interface for all xyz scenegraph nodes"})

// NodeBaseType is the [gti.Type] for [NodeBase]
var NodeBaseType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.NodeBase", IDName: "node-base", Doc: "NodeBase is the basic 3D scenegraph node, which has the full transform information\nrelative to parent, and computed bounding boxes, etc.\nThere are only two different kinds of Nodes: Group and Solid", Embeds: []gti.Field{{Name: "NodeBase"}}, Fields: []gti.Field{{Name: "Pose", Doc: "complete specification of position and orientation"}, {Name: "Sc", Doc: "Sc is the cached Scene"}, {Name: "PoseMu", Doc: "mutex on pose access -- needed for parallel updating"}, {Name: "MeshBBox", Doc: "mesh-based local bounding box (aggregated for groups)"}, {Name: "WorldBBox", Doc: "world coordinates bounding box"}, {Name: "NDCBBox", Doc: "normalized display coordinates bounding box, used for frustrum clipping"}, {Name: "BBox", Doc: "raw original bounding box for the widget within its parent Scene.\nThis is prior to intersecting with Frame bounds."}, {Name: "ScBBox", Doc: "2D bounding box for region occupied within Scene Frame that we render onto.\nThis is BBox intersected with Frame bounds."}}, Instance: &NodeBase{}})
...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.TexName", IDName: "tex-name", Doc: "TexName provides a GUI interface for choosing textures"})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.Texture", IDName: "texture", Doc: "Texture is the interface for all textures"})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.TextureBase", IDName: "texture-base", Doc: "TextureBase is the base texture implementation\nit uses an image.RGBA as underlying image storage to facilitate interface with GPU", Fields: []gti.Field{{Name: "Nm", Doc: "name of the texture -- textures are connected to material by name"}, {Name: "Trans", Doc: "set to true if texture has transparency"}, {Name: "Img", Doc: "cached image"}}})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.TextureFile", IDName: "texture-file", Doc: "TextureFile is a texture loaded from a file", Embeds: []gti.Field{{Name: "TextureBase"}}, Fields: []gti.Field{{Name: "FSys", Doc: "filesystem for embedded etc"}, {Name: "File", Doc: "filename for the texture"}}})

var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.TextureGi2D", IDName: "texture-gi2-d", Doc: "TextureGi2D is a dynamic texture material driven by a core.Viewport2D viewport\nanything rendered to the viewport will be projected onto the surface of any\nsolid using this texture.", Embeds: []gti.Field{{Name: "TextureBase"}}})
