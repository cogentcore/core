...
var _ = gti.AddType(&gti.Type{Name: "cogentcore.org/core/xyz.TextureGi2D", IDName: "texture-gi2-d", Doc: "TextureGi2D is a dynamic texture material driven by a gi.Viewport2D viewport\nanything rendered to the viewport will be projected onto the surface of any\nsolid using this texture.", Embeds: []gti.Field{{Name: "TextureBase"}}})
