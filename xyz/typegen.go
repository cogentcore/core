...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/xyz.Line", IDName: "line", Doc: "Line is a Solid that is used for line elements.\nType is need to trigger more precise event handling.", Directives: []types.Directive{{Tool: "core", Directive: "no-new"}}, Embeds: []types.Field{{Name: "Solid"}}})
