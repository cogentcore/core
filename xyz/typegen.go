...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/xyz.Camera", IDName: "camera", Doc: "Camera defines the properties of the camera", Fields: []types.Field{{Name: "Pose", Doc: "Pose is the overall orientation and direction of the camera,\nrelative to pointing at negative Z axis with up (positive Y) direction."}, {Name: "Target", Doc: "Target location for the camera to point at, which defaults to the origin.\nThis moves with panning movements, and is reset by a call to LookAt method"}, {Name: "UpDir", Doc: "UpDir is the upward direction for camera, which defaults to positive Y axis,\nand is reset by LookAt method."}, {Name: "Ortho", Doc: "Ortho switches to using Orthographic instead of default Perspective\ncamera. For Ortho, the view includes the volume specified by the\nNear - Far distance (i.e., you probably want to decrease Far)."}, {Name: "FOV", Doc: "FOV is field of view in degrees."}, {Name: "Aspect", Doc: "Aspect is the aspect ratio (width/height)."}, {Name: "Near", Doc: "Near plane z coordinate."}, {Name: "Far", Doc: "Far plane z coordinate."}, {Name: "ViewMatrix", Doc: "ViewMatrix is the inverse of the Pose.Matrix."}, {Name: "ProjectionMatrix", Doc: "ProjectionMatrix defines the camera perspective / ortho transform."}, {Name: "InvProjectionMatrix", Doc: "InvProjectionMatrix is the inverse of the projection matrix."}, {Name: "Frustum", Doc: "Frustum of projection: viewable space defined by 6 planes of a pyrammidal shape."}}})
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/xyz.Object", IDName: "object", Doc: "Object is an object cloned from a Library.", Embeds: []types.Field{{Name: "Group"}}, Fields: []types.Field{{Name: "ObjectName", Doc: "ObjectName is the name of the object to load from the Library."}, {Name: "currentName", Doc: "currentName is the name of the object currently loaded.\nif ObjectName is different than this, it is loaded on Update."}}})

// NewObject returns a new [Object] with the given optional parent:
// Object is an object cloned from a Library.
func NewObject(parent ...tree.Node) *Object { return tree.New[Object](parent...) }

// SetObjectName sets the [Object.ObjectName]:
// ObjectName is the name of the object to load from the Library.
func (t *Object) SetObjectName(v string) *Object { t.ObjectName = v; return t }
