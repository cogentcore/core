...
func (ph *Phong) AddPointLight(color, pos math32.Vec3, linDecay, quadDecay float32) {
...
// Defaults: linDecay=.1, quadDecay=.01
func (ph *Phong) SetPointLight(idx int, color, pos math32.Vec3, linDecay, quadDecay float32) {
	ph.Point[idx].Color = color
	ph.Point[idx].Pos = pos
	ph.Point[idx].Decay = math32.Vec3{X: linDecay, Y: quadDecay}
}

// AddSpotLight adds spot light
// Defaults: angDecay=15, cutAngle=45 (max 90), linDecay=.01, quadDecay=0.001
func (ph *Phong) AddSpotLight(color, pos, dir math32.Vec3, angDecay, cutAngle, linDecay, quadDecay float32) {
...
// Defaults: angDecay=15, cutAngle=45 (max 90), linDecay=.01, quadDecay=0.001
func (ph *Phong) SetSpotLight(idx int, color, pos, dir math32.Vec3, angDecay, cutAngle, linDecay, quadDecay float32) {
	ph.Spot[idx].Color = color
	ph.Spot[idx].Pos = pos
	ph.Spot[idx].Dir = dir
	ph.Spot[idx].Decay = math32.V4(angDecay, cutAngle, linDecay, quadDecay)
}
