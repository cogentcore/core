...
var DurationInputType = types.AddType(&types.Type{Name: "cogentcore.org/core/views.DurationInput", IDName: "duration-input", Doc: "DurationInput represents a [time.Duration] value with a spinner and unit chooser.", Embeds: []types.Field{{Name: "Frame"}}, Fields: []types.Field{{Name: "Duration"}}, Instance: &DurationInput{}})
