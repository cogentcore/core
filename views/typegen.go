...
import (
	...
	// NewArgView adds a new [ArgView] to the given optional parent:
	// ArgView represents a slice of reflect.Value's and associated names, for the
// purpose of supplying arguments to methods called via the MethodView
// framework.
	func NewArgView(parent ...tree.Node) *ArgView {
		return tree.New[*ArgView](parent...)
	}
	...
	// NewColorView adds a new [ColorView] to the given optional parent:
	// ColorView shows a color, using sliders or numbers to set values.
	func NewColorView(parent ...tree.Node) *ColorView {
		return tree.New[*ColorView](parent...)
	}
	...
	// NewFileView adds a new [FileView] to the given optional parent:
	// FileView is a viewer onto files -- core of the file chooser dialog
	func NewFileView(parent ...tree.Node) *FileView {
		return tree.New[*FileView](parent...)
	}
...
// function is executed
	...
	// NewInspector adds a new [Inspector] to the given optional parent:
...
// box at the bottom where methods can be invoked
	func NewInspector(parent ...tree.Node) *Inspector {
		return tree.New[*Inspector](parent...)
	}
	...
	// NewMapView adds a new [MapView] to the given optional parent:
	// MapView represents a map using two columns of editable key and value widgets.
	func NewMapView(parent ...tree.Node) *MapView {
		return tree.New[*MapView](parent...)
	}
...
// It is displayed as extra contextual information in view dialogs.
	...
	// NewMapViewInline adds a new [MapViewInline] to the given optional parent:
	// MapViewInline represents a map within a single line of key and value widgets.
// This is typically used for smaller maps.
	func NewMapViewInline(parent ...tree.Node) *MapViewInline {
		return tree.New[*MapViewInline](parent...)
	}
...
// It is displayed as extra contextual information in view dialogs.
	...
	// NewSliceView adds a new [SliceView] to the given optional parent:
...
// Use [SliceViewBase.BindSelect] to make the slice view designed for item selection.
	func NewSliceView(parent ...tree.Node) *SliceView {
		return tree.New[*SliceView](parent...)
	}
	...
	// NewSliceViewBase adds a new [SliceViewBase] to the given optional parent:
	// SliceViewBase is the base for [SliceView] and [TableView] and any other viewers
// of array-like data. It automatically computes the number of rows that fit
// within its allocated space, and manages the offset view window into the full
// list of items, and supports row selection, copy / paste, Drag-n-Drop, etc.
// Use [SliceViewBase.BindSelect] to make the slice view designed for item selection.
	func NewSliceViewBase(parent ...tree.Node) *SliceViewBase {
		return tree.New[*SliceViewBase](parent...)
	}
...
// It is displayed as extra contextual information in view dialogs.
	...
	// NewSliceViewGrid adds a new [SliceViewGrid] to the given optional parent:
	// SliceViewGrid handles the resizing logic for SliceView, TableView.
	func NewSliceViewGrid(parent ...tree.Node) *SliceViewGrid {
		return tree.New[*SliceViewGrid](parent...)
	}
...
// backgrounds were computed -- don't update if same
	func (t *SliceViewGrid) SetLastBackground(v image.Image) *SliceViewGrid { t.LastBackground = v; return t }
	...
	// NewSliceViewInline adds a new [SliceViewInline] to the given optional parent:
...
// It is displayed as extra contextual information in view dialogs.
	...
	// NewStructView adds a new [StructView] to the given optional parent:
	// StructView represents a struct with rows of field names and editable values.
	func NewStructView(parent ...tree.Node) *StructView {
		return tree.New[*StructView](parent...)
	}
...
// It is displayed as extra contextual information in view dialogs.
	...
	// NewStructViewInline adds a new [StructViewInline] to the given optional parent:
...
// Use [SliceViewBase.BindSelect] to make the table view designed for item selection.
	...
	// NewTimeView adds a new [TimeView] to the given optional parent:
	// TimeView is a view for selecting a time
	func NewTimeView(parent ...tree.Node) *TimeView {
		return tree.New[*TimeView](parent...)
	}
	...
	// NewDateView adds a new [DateView] to the given optional parent:
	// DateView is a view for selecting a date
	func NewDateView(parent ...tree.Node) *DateView {
		return tree.New[*DateView](parent...)
	}
	...
	// NewTreeView adds a new [TreeView] to the given optional parent:
...
// are in the root SelectedNodes list.
	func NewTreeView(parent ...tree.Node) *TreeView {
		return tree.New[*TreeView](parent...)
	}
