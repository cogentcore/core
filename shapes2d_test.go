...
func TestRect(t *testing.T) {
	...
	rect1 := parent.AddNewChildNamed(reflect.TypeOf(Rect{}), "rect1").(*Rect)
...
func TestShapesAll(t *testing.T) {
	...
	circle1 := parent.AddNewChildNamed(reflect.TypeOf(Circle{}), "circle1").(*Circle)
	...
	ellipse1 := circle1.AddNewChildNamed(reflect.TypeOf(Ellipse{}), "ellipse1").(*Ellipse)
	...
	line1 := parent.AddNewChildNamed(reflect.TypeOf(Line{}), "line1").(*Line)
	line1.SetProp("stroke", "#888800")
	line1.SetProp("stroke-width", 5.0)
	line1.Start = Point2D{100, 100}
	line1.End = Point2D{150, 200}

	polyline1 := parent.AddNewChildNamed(reflect.TypeOf(Polyline{}), "polyline1").(*Polyline)
	...
	polygon1 := parent.AddNewChildNamed(reflect.TypeOf(Polygon{}), "polygon1").(*Polygon)
