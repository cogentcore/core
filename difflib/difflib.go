...
// LineDiffParams Unified diff parameters
...
// ContextDiff For backward compatibility. Ugh.
...
// GetContextDiffString Like WriteContextDiff but returns the diff as a string.
