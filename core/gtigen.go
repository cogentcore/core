...
var BoxType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/core.Box", IDName: "box", Doc: "Box is a simple base [Widget] that renders the standard box model.", Embeds: []gti.Field{{Name: "WidgetBase"}}, Instance: &Box{}})
...
var FrameType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/core.Frame", IDName: "frame", Doc: "Frame is a Layout that renders a background according to the\nbackground-color style setting, and optional striping for grid layouts", Embeds: []gti.Field{{Name: "Layout"}}, Instance: &Frame{}})
...
var ScrimType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/core.Scrim", IDName: "scrim", Doc: "A Scrim is just a dummy Widget used for rendering a Scrim.\nOnly used for its type. Everything else managed by RenderWin.", Embeds: []gti.Field{{Name: "WidgetBase"}}, Instance: &Scrim{}})
...
var SeparatorType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/core.Separator", IDName: "separator", Doc: "Separator draws a separator line. It goes in the direction\nspecified by [style.Style.Direction].", Embeds: []gti.Field{{Name: "Box"}}, Instance: &Separator{}})
...
// SetUndoMgr sets the [TextField.UndoMgr]:
// the undo manager
func (t *TextField) SetUndoMgr(v TextFieldUndoMgr) *TextField { t.UndoMgr = v; return t }
...
var BasicBarType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/core.BasicBar", IDName: "basic-bar", Doc: "BasicBar is just a styled Frame layout for holding buttons\nand other widgets.  Use this when the more advanced features\nof the Toolbar are not needed.", Embeds: []gti.Field{{Name: "Frame"}}, Instance: &BasicBar{}})
...
var _ = gti.AddFunc(&gti.Func{Name: "cogentcore.org/core/core.ProfileToggle", Doc: "ProfileToggle turns profiling on or off, which does both\ntargeted and global CPU and Memory profiling.", Directives: []gti.Directive{{Tool: "gti", Directive: "add"}}})

var _ = gti.AddFunc(&gti.Func{Name: "cogentcore.org/core/core.ResetAllSettings", Doc: "ResetAllSettings resets all of the settings to their default values.", Directives: []gti.Directive{{Tool: "gti", Directive: "add"}}, Returns: []string{"error"}})

var _ = gti.AddFunc(&gti.Func{Name: "cogentcore.org/core/core.UpdateAll", Doc: "UpdateAll updates all windows and triggers a full render rebuild.\nIt is typically called when user settings are changed.", Directives: []gti.Directive{{Tool: "gti", Directive: "add"}}})
