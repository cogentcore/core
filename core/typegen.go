...
// SetScrolls sets the [Frame.Scrolls]:
// Scrolls are the scroll bars, which are fully managed as needed.
func (t *Frame) SetScrolls(v [2]*Slider) *Frame { t.Scrolls = v; return t }
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/core.Icon", IDName: "icon", Doc: "Icon renders an [icons.Icon].\nThe rendered version is cached for the current size.\nIcons do not render a background or border independent of their SVG object.\nThe size of an Icon is determined by the [styles.Text.FontSize] property.", Embeds: []types.Field{{Name: "WidgetBase"}}, Fields: []types.Field{{Name: "Icon", Doc: "Icon is the [icons.Icon] used to render the [Icon]."}, {Name: "prevIcon", Doc: "prevIcon is the previously rendered icon."}, {Name: "svg", Doc: "svg drawing of the icon"}}})
...
// SetChangeOnSlide sets the [Slider.ChangeOnSlide]:
// ChangeOnSlide sends [events.Change] events while sliding, instead of only
// at the end when done sliding.
func (t *Slider) SetChangeOnSlide(v bool) *Slider { t.ChangeOnSlide = v; return t }
...
// SetLinks sets the [Text.Links]:
// Links is the list of links in the text.
func (t *Text) SetLinks(v ...rich.Hyperlink) *Text { t.Links = v; return t }
