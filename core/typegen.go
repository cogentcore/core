...
// SetMenuSearchInit sets the [Scene.MenuSearchInit]:
// MenuSearchInit is a function called with the menu search chooser
// created by the default Scene context menu.
func (t *Scene) SetMenuSearchInit(v func(w *Chooser)) *Scene { t.MenuSearchInit = v; return t }
