...
var ToolbarType = types.AddType(&types.Type{Name: "cogentcore.org/core/core.Toolbar", IDName: "toolbar", Doc: "Toolbar is a [Frame] that is useful for holding [Button]s that do things.\nIt automatically moves items that do not fit into an overflow menu, and\nmanages additional items that are always placed onto this overflow menu.\nIn general it should be possible to use a single toolbar + overflow to\nmanage all an app's functionality, in a way that is portable across\nmobile and desktop environments.\nSee [Widget.MakeToolbar] for the standard toolbar config method for\nany given widget, and [Scene.AppBars] for [ConfigFuncs] for [Scene]\nelements who should be represented in the main AppBar (e.g., TopAppBar).", Methods: []types.Method{{Name: "StandardOverflowMenu", Doc: "StandardOverflowMenu adds standard overflow menu items.", Directives: []types.Directive{{Tool: "types", Directive: "add"}}, Args: []string{"m"}}}, Embeds: []types.Field{{Name: "Frame"}}, Fields: []types.Field{{Name: "OverflowItems", Doc: "OverflowItems are items moved from the main toolbar that will be shown in the overflow menu."}, {Name: "OverflowMenus", Doc: "OverflowMenus are functions for the overflow menu; use [Toolbar.AddOverflowMenu] to add.\nThese are processed in reverse order (last in, first called)\nso that the default items are added last."}, {Name: "Makers", Doc: "Makers contains functions for making the plan for the toolbar.\nYou can use [Toolbar.AddMaker] to add a new one."}, {Name: "OverflowButton", Doc: "This is the overflow button"}}, Instance: &Toolbar{}})
