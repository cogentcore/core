...
// that should be represented in any app-level toolbar constructed
// for this Scene.
func (t *Scene) SetAppBars(v ConfigFuncs) *Scene { t.AppBars = v; return t }

// SetAppChoosers sets the [Scene.AppChoosers]:
// AppChoosers contains functions for configuring a top-level App chooser,
// (e.g., TopAppBar) for elements contained within this Scene.
func (t *Scene) SetAppChoosers(v ConfigChooserFuncs) *Scene { t.AppChoosers = v; return t }
...
// SetConfigFuncs sets the [Toolbar.ConfigFuncs]:
// ConfigFuncs contains functions for configuring this toolbar,
// called on Config
func (t *Toolbar) SetConfigFuncs(v ConfigFuncs) *Toolbar { t.ConfigFuncs = v; return t }
