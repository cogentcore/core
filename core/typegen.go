...
func (t *List) SetStyleFunc(v ListStyler) *List { t.ListStyler = v; return t }
...
// StyleFunc is an optional styling function.
func (t *Table) SetStyleFunc(v TableStyler) *Table { t.TableStyler = v; return t }
