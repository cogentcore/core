...
// SetDisableAppBar sets the [Scene.DisableAppBar]:
// DisableAppBar is whether to disable the default top app bar for this Scene.
// You can set this for all Scenes using [App.SceneInit].
func (t *Scene) SetDisableAppBar(v bool) *Scene { t.DisableAppBar = v; return t }
...
func (t *Tree) SetTreeInit(v func(tr *Tree)) *Tree { t.TreeInit = v; return t }
