...
// if it is nil. The constructor function should add buttons
// to the Scene that it is passed. Position is mouse click position.
func (t *Button) SetMenu(v func(m *Scene, pos image.Point)) *Button { t.Menu = v; return t }
...
// SetNewTabFunc sets the [Tabs.NewTabFunc]:
// NewTabFunc is a function that will be called when the NewTabButton
// is clicked to create a new tab, with the index of this new tab.
// This can be used to update the new tab contents.
func (t *Tabs) SetNewTabFunc(v func(index int)) *Tabs { t.NewTabFunc = v; return t }

// SetCloseTabFunc sets the [Tabs.CloseTabFunc]:
...
func (t *Tabs) SetCloseTabFunc(v func(index int)) *Tabs { t.CloseTabFunc = v; return t }
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/core.Text", IDName: "text", Doc: "Text is a widget for rendering text. It supports full HTML styling,\nincluding links. By default, text wraps and collapses whitespace, although\nyou can change this by changing [styles.Text.WhiteSpace].", Methods: []types.Method{{Name: "copy", Directives: []types.Directive{{Tool: "types", Directive: "add"}}}}, Embeds: []types.Field{{Name: "WidgetBase"}}, Fields: []types.Field{{Name: "Text", Doc: "Text is the text to display."}, {Name: "Type", Doc: "Type is the styling type of text to use.\nIt defaults to [TextBodyLarge]."}, {Name: "Links", Doc: "Links is the list of links in the text."}, {Name: "richText", Doc: "richText is the conversion of the HTML text source.\nThis is what is actually rendered."}, {Name: "selectRange", Doc: "SelectRange is the selected range, in terms of rune indexes\ninto the richText.Join() runes."}, {Name: "highlights", Doc: "highlights are regions that will be highlighted in the text\nwhen rendered. Indexes are into richText.Join() runes."}, {Name: "paintText", Doc: "paintText is the [shaped.Lines] for the text."}, {Name: "normalCursor", Doc: "normalCursor is the cached cursor to display when there\nis no link being hovered."}}})
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/core.ImageButton", IDName: "image-button", Doc: "ImageButton represents an image.Image value with a button that opens a [Image].", Embeds: []types.Field{{Name: "Button"}}, Fields: []types.Field{{Name: "Image"}}})

// NewImageButton returns a new [ImageButton] with the given optional parent:
// ImageButton represents an image.Image value with a button that opens a [Image].
func NewImageButton(parent ...tree.Node) *ImageButton { return tree.New[ImageButton](parent...) }

// SetImage sets the [ImageButton.Image]
func (t *ImageButton) SetImage(v image.Image) *ImageButton { t.Image = v; return t }
