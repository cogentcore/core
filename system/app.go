...
var (
	...
	ReservedWebShortcuts = []string{"Command+r", "Shift+Command+r", "Command+w", "Command+t", "Shift+Command+t", "Command+q", "Command+n", "Command+m", "Command+l", "Command+h", "Shift+Command+c", "Alt+Command+c", "Command+1", "Command+2", "Command+3", "Command+4", "Command+5", "Command+6", "Command+7", "Command+8", "Command+9"}
)
