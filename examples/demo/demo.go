...
func inputs(ts *gi.Tabs) {
	...
	gi.NewTextField(tab).SetPlaceholder("Filled").SetSupportingText("Filled text field")
	gi.NewTextField(tab).SetType(gi.TextFieldOutlined).SetPlaceholder("Outlined").SetErrorText("Invalid value")
