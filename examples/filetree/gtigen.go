...
var FileBrowseType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"ActiveFilename", &gti.Field{Name: "ActiveFilename", Type: "goki.dev/gi.FileName", LocalType: "gi.FileName", Doc: "filename of the currently-active texteditor", Directives: gti.Directives{}, Tag: "desc:\"filename of the currently-active texteditor\""}},
		...
		{"Files", &gti.Field{Name: "Files", Type: "*goki.dev/filetree.Tree", LocalType: "*filetree.Tree", Doc: "all the files in the project directory and subdirectories", Directives: gti.Directives{}, Tag: "desc:\"all the files in the project directory and subdirectories\""}},
