...
type DlgOpts struct {
	Title    string    `desc:"generally should be provided -- used for setting name of dialog and associated window"`                                                                                                                                                                                                                                         // generally should be provided -- used for setting name of dialog and associated window
	...
	Ok       bool      `desc:"display the Ok button, in most View dialogs where it otherwise is not shown by default -- these views always apply edits immediately, and typically this obviates the need for Ok and Cancel, but sometimes you're giving users a temporary object to edit, and you want them to indicate if they want to proceed or not."`     // display the Ok button, in most View dialogs where it otherwise is not shown by default -- these views always apply edits immediately, and typically this obviates the need for Ok and Cancel, but sometimes you're giving users a temporary object to edit, and you want them to indicate if they want to proceed or not.
	Cancel   bool      `desc:"display the Cancel button, in most View dialogs where it otherwise is not shown by default -- these views always apply edits immediately, and typically this obviates the need for Ok and Cancel, but sometimes you're giving users a temporary object to edit, and you want them to indicate if they want to proceed or not."` // display the Cancel button, in most View dialogs where it otherwise is not shown by default -- these views always apply edits immediately, and typically this obviates the need for Ok and Cancel, but sometimes you're giving users a temporary object to edit, and you want them to indicate if they want to proceed or not.
	NoAdd    bool      `desc:"if true, user cannot add elements of the slice"`                                                                                                                                                                                                                                                                                // if true, user cannot add elements of the slice
	NoDelete bool      `desc:"if true, user cannot delete elements of the slice"`                                                                                                                                                                                                                                                                             // if true, user cannot delete elements of the slice
	Inactive bool      `desc:"if true all fields will be inactive"`                                                                                                                                                                                                                                                                                           // if true all fields will be inactive
	Data     any       `desc:"if non-nil, this is data that identifies what the dialog is about -- if an existing dialog for such data is already in place, then it is shown instead of making a new one"`                                                                                                                                                    // if non-nil, this is data that identifies what the dialog is about -- if an existing dialog for such data is already in place, then it is shown instead of making a new one
	Filename string    `desc:"filename, e.g., for TextView, to get highlighting"`                                                                                                                                                                                                                                                                             // filename, e.g., for TextView, to get highlighting
	LineNos  bool      `desc:"include line numbers for TextView"`                                                                                                                                                                                                                                                                                             // include line numbers for TextView
}
