...
// SetIconOn sets the [TreeView.IconOn]:
// icon to use for the on, checked state of the switch
func (t *TreeView) SetIconOn(v icons.Icon) *TreeView { t.IconOn = v; return t }

// SetIconOff sets the [TreeView.IconOff]:
// icon to use for the off, unchecked state of the switch
func (t *TreeView) SetIconOff(v icons.Icon) *TreeView { t.IconOff = v; return t }

// SetIconIndeterminate sets the [TreeView.IconIndeterminate]:
// icon to use for the indeterminate (unknown) state
func (t *TreeView) SetIconIndeterminate(v icons.Icon) *TreeView { t.IconIndeterminate = v; return t }
