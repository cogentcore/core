...
// SetTree sets the [TreeTableView.Tree]:
// Tree is the tree view component of the tree table view.
func (t *TreeTableView) SetTree(v *TreeView) *TreeTableView { t.Tree = v; return t }

// SetTable sets the [TreeTableView.Table]:
// Table is the table view component of the tree table view.
func (t *TreeTableView) SetTable(v *TableView) *TreeTableView { t.Table = v; return t }
