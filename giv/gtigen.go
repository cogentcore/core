...
// SetIconUnk sets the [TreeView.IconUnk]:
// icon to use for the indeterminate (unknown) state
func (t *TreeView) SetIconUnk(v icons.Icon) *TreeView { t.IconUnk = v; return t }
