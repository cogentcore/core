...
var _CatValueMap = map[string]Cat{`UnknownCat`: 0, `Folder`: 1, `Archive`: 2, `Backup`: 3, `Code`: 4, `Doc`: 5, `Sheet`: 6, `Data`: 7, `Text`: 8, `Image`: 9, `Model`: 10, `Audio`: 11, `Video`: 12, `Font`: 13, `Exe`: 14, `Bin`: 15}
...
func (i Cat) String() string { return enums.String(i, _CatMap) }

// SetString sets the Cat value from its string representation,
// and returns an error if the string is invalid.
func (i *Cat) SetString(s string) error { return enums.SetString(i, s, _CatValueMap, "Cat") }
...
func (i Cat) Desc() string { return enums.Desc(i, _CatDescMap) }
...
func (i Cat) Values() []enums.Enum { return enums.Values(_CatValues) }

// MarshalText implements the [encoding.TextMarshaler] interface.
func (i Cat) MarshalText() ([]byte, error) { return []byte(i.String()), nil }

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *Cat) UnmarshalText(text []byte) error { return enums.UnmarshalText(i, text, "Cat") }
