...
var _MetricsValueMap = map[string]Metrics{`NormL2`: 0, `SumSquares`: 1, `NormL1`: 2, `Hamming`: 3, `NormL2BinTol`: 4, `SumSquaresBinTol`: 5, `InvCosine`: 6, `InvCorrelation`: 7, `CrossEntropy`: 8, `DotProduct`: 9, `Covariance`: 10, `Correlation`: 11, `Cosine`: 12}
...
var _MetricsMap = map[Metrics]string{0: `NormL2`, 1: `SumSquares`, 2: `NormL1`, 3: `Hamming`, 4: `NormL2BinTol`, 5: `SumSquaresBinTol`, 6: `InvCosine`, 7: `InvCorrelation`, 8: `CrossEntropy`, 9: `DotProduct`, 10: `Covariance`, 11: `Correlation`, 12: `Cosine`}
