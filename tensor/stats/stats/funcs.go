...
// See [StatsFunc] for general information.
func SumAbs(in tensor.Tensor) tensor.Values {
	return tensor.CallOut1(SumAbsOut, in)
}

// SumAbsOut computes the sum of absolute-value-of tensor values.
// This is also known as the L1 norm.
// See [StatsFunc] for general information.
func SumAbsOut(in tensor.Tensor, out tensor.Values) error {
