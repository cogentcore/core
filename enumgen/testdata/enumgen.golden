// Code generated by "enumgen.test.exe -test.testlogfile=C:\Users\korei\AppData\Local\Temp\go-build4166764614\b139\testlog.txt -test.paniconexit0 -test.timeout=10m0s"; DO NOT EDIT.
...
func (i States) Has(f enums.BitFlag) bool {
	return i&(1<<uint32(f.Int64())) != 0
}

// Set sets the value of the given
// flags in these flags to the given value.
func (i *States) Set(on bool, f ...enums.BitFlag) {
	var mask int64
	for _, v := range f {
		mask |= 1 << v.Int64()
	}
...
// Has returns whether these
// bit flags have the given bit flag set.
func (i Languages) Has(f enums.BitFlag) bool {
	return i&(1<<uint32(f.Int64())) != 0
}

// Set sets the value of the given
// flags in these flags to the given value.
func (i *Languages) Set(on bool, f ...enums.BitFlag) {
	var mask int64
	for _, v := range f {
		mask |= 1 << v.Int64()
	}
