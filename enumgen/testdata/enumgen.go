// Code generated by "enumgen.test.exe -test.testlogfile=C:\Users\korei\AppData\Local\Temp\go-build1795638724\b142\testlog.txt -test.paniconexit0 -test.timeout=10m0s"; DO NOT EDIT.
	...
	*i = 0
	...
	for _, flg := range flgs {
		if val, ok := _StatesNameToValueMap[flg]; ok {
			...
			return errors.New(s + " is not a valid value for type States")
		}
	}
	return nil
}
	...
	*i = 0
	...
	for _, flg := range flgs {
		if val, ok := _LanguagesNameToValueMap[flg]; ok {
			...
			return errors.New(s + " is not a valid value for type Languages")
		}
	}
	return nil
}
