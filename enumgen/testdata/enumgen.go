// Code generated by "enumgen.test -test.testlogfile=/var/folders/04/lx4zq1q57v19rz0nyl_hkbp00000gq/T/go-build2003039527/b141/testlog.txt -test.paniconexit0 -test.timeout=10m0s"; DO NOT EDIT.
...
// Strings returns the string representations of
// all possible values of type Foods.
// This slice will be in the same order as
// those returned by Values and Descs.
func (i Foods) Strings() []string {
	return _FoodsNames
}

// Descs returns the descriptions of all
// possible values of type Foods.
// This slice will be in the same order as
// those returned by Values and Strings.
func (i Foods) Descs() []string {
	return _FoodsDescs
}
