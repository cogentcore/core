...
type TextField struct {
	...
	CmpltrCB     func() []string         `desc:"callback to get the list of possible matches if not generated by the completer itself"`
}
...
func (tf *TextField) OfferCompletions() {
	...
	if !found {
		...
		ctStr := ct.(string)
		//fmt.Println(ctStr)
		cmpltr, err := CreateCompleter(ctStr, tf.CmpltrCB)
		if err == nil {
