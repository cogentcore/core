...
Text is \textbf{bold} and \emph{emphasized} and this is \textt{code output} or \textbf{bold and \emph{emph}} or whatever.  also 1234 numbers are good.  I usually use the {\bf old school} way of doing {\em emphasis etc} so that's too bad.  \verb\http:addr.com\ is pretty good too.
