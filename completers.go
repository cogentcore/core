...
type BaseCompleter struct {
	...
	completions []string
	matches     []string
	cb          func() []string // callback to get the list of possible matches if not generated by the completer itself
}

////////////////////////////////////////////////////////////////////////////////////////
// CreateCompleter - a factory to create different types of text completers
func CreateCompleter(s string, cb func() []string) (Completer, error) {
	//func CreateCompleter(s string, cb func()[]string) (Completer, error) {
	switch s {
	case "word-completer":
		c := new(WordCompleter)
