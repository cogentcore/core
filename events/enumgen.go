...
var _TypesDescMap = map[Types]string{
	...
	38: `Show is generated by an overall Scene container when the content is first shown to the user in its final form. Listening to this event enables other elements to perform initial one-time activities on startup, in the context of a fully rendered display. This is guaranteed to only happen once per Scene.`,
