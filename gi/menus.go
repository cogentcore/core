...
type MenuButton struct {
	...
	// type is the type of the menu button
...
func (mb *MenuButton) ConfigStyles() {
	mb.AddStyleFunc(StyleFuncDefault, func() {
		...
		mb.Style.Color = ColorScheme.OnBackground
		...
		case MenuButtonOutlined:
			...
			mb.Style.Border.Color.Set(ColorScheme.OnBackground)
		...
		case ButtonInactive:
			...
			mb.Style.Color = ColorScheme.OnBackground.Highlight(20)
