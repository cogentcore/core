...
var SeparatorType = gti.AddType(&gti.Type{Name: "cogentcore.org/core/gi.Separator", IDName: "separator", Doc: "Separator draws a vertical or horizontal line", Embeds: []gti.Field{{Name: "Box"}}, Fields: []gti.Field{{Name: "Dim", Doc: "Dim is the dimension the separator goes along (X means it goes longer horizontally, etc)"}}, Instance: &Separator{}})
