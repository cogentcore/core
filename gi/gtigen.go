...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"KeyMap", &gti.Field{Name: "KeyMap", Type: "goki.dev/gi/v2/gi.KeyMapName", LocalType: "KeyMapName", Doc: "select the active keymap from list of available keymaps -- see Edit KeyMaps for editing / saving / loading that list", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"CompleteWaitMSec", &gti.Field{Name: "CompleteWaitMSec", Type: "int", LocalType: "int", Doc: "the number of milliseconds to wait before offering completions", Directives: gti.Directives{}, Tag: "def:\"0\" min:\"0\" max:\"10000\" step:\"10\""}},
