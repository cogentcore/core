...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Density", &gti.Field{Name: "Density", Type: "float32", LocalType: "float32", Doc: "the overall density factor as a percentage of the default amount of spacing\n(smaller numbers lead to more density and larger numbers lead to more space)", Directives: gti.Directives{}, Tag: "def:\"100\" min:\"10\" max:\"1000\" step:\"10\""}},
