...
var WidgetBaseType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"WinBBox", &gti.Field{Name: "WinBBox", Type: "image.Rectangle", Doc: "2D bounding box for region occupied within parent OSWin object, projected all the way up to that -- these are the coordinates where we receive events, relative to the window", Directives: gti.Directives{}}},
