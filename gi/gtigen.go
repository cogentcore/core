...
var ToolbarType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"OverflowItems", &gti.Field{Name: "OverflowItems", Type: "[]goki.dev/gi/v2/gi.Widget", LocalType: "[]Widget", Doc: "items moved from the main toolbar", Directives: gti.Directives{}, Tag: "set:\"-\" json:\"-\" xml:\"-\""}},
