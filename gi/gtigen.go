...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"LayoutFocusNameTimeout", &gti.Field{Name: "LayoutFocusNameTimeout", Type: "int", LocalType: "int", Doc: "the number of milliseconds between keypresses to combine characters into name to search for within layout -- starts over after this delay", Directives: gti.Directives{}, Tag: "def:\"500\" min:\"0\" max:\"5000\" step:\"20\""}},
		{"LayoutFocusNameTabTime", &gti.Field{Name: "LayoutFocusNameTabTime", Type: "int", LocalType: "int", Doc: "the number of milliseconds since last focus name event to allow tab to focus on next element with same name.", Directives: gti.Directives{}, Tag: "def:\"2000\" min:\"10\" max:\"10000\" step:\"100\""}},
...
// SetPriorityEvents sets the [Snackbar.PriorityEvents]
func (t *Snackbar) SetPriorityEvents(v []events.Types) *Snackbar {
	t.PriorityEvents = v
	return t
}
...
// SetBody sets the [Snackbar.Body]
func (t *Snackbar) SetBody(v *Body) *Snackbar {
	t.Body = v
	return t
}
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"FullWindow", &gti.Field{Name: "FullWindow", Type: "bool", LocalType: "bool", Doc: "if NewWindow is false, then this makes Dialogs and Windows take up the entire window they are created in", Directives: gti.Directives{}, Tag: ""}},
