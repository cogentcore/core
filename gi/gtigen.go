...
var CompleteType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Vp", &gti.Field{Name: "Vp", Type: "*Scene", Doc: "the viewport where the current popup menu is presented", Directives: gti.Directives{}}},
...
var WidgetBaseType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"VpBBox", &gti.Field{Name: "VpBBox", Type: "image.Rectangle", Doc: "2D bounding box for region occupied within immediate parent Scene object that we render onto -- these are the pixels we draw into, filtered through parent bounding boxes -- used for render Bounds clipping", Directives: gti.Directives{}}},
		...
		{"Vp", &gti.Field{Name: "Vp", Type: "*Scene", Doc: "parent viewport.  Only for use as a last resort when arg is not available -- otherwise always use the arg.  Set during Config.", Directives: gti.Directives{}}},
