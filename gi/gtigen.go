...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"LayoutAutoScrollDelay", &gti.Field{Name: "LayoutAutoScrollDelay", Type: "int", LocalType: "int", Doc: "is amount of time to wait before trying to autoscroll again", Directives: gti.Directives{}, Tag: "def:\"25\" min:\"1\" step:\"5\""}},
...
var WidgetBaseType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Alloc", &gti.Field{Name: "Alloc", Type: "goki.dev/gi/v2/gi.LayState", LocalType: "LayState", Doc: "Alloc is layout allocation state: contains full size and position info", Directives: gti.Directives{}, Tag: "edit:\"-\" copy:\"-\" json:\"-\" xml:\"-\" set:\"-\""}},
		...
		{"LayState", &gti.Field{Name: "LayState", Type: "goki.dev/gi/v2/gi.LayState", LocalType: "LayState", Doc: "all the layout state information for this widget", Directives: gti.Directives{}, Tag: "edit:\"-\" copy:\"-\" json:\"-\" xml:\"-\" set:\"-\""}},
