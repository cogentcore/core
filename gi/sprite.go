...
func (sp *Sprite) ConnectEvent(recv ki.Ki, et goosi.EventTypes, fun ki.RecvFunc) {
	if sp.Events == nil {
...
func (sp *Sprite) DisconnectEvent(recv ki.Ki, et goosi.EventTypes, fun ki.RecvFunc) {
	if sp.Events == nil {
		return
	}
	sg, ok := sp.Events[et]
