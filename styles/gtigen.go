...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Width", &gti.Field{Name: "Width", Type: "goki.dev/girl/styles.SideValues", LocalType: "SideValues", Doc: "prop: border-width = width of the border", Directives: gti.Directives{}, Tag: "xml:\"width\" view:\"inline\""}},
		{"Radius", &gti.Field{Name: "Radius", Type: "goki.dev/girl/styles.SideValues", LocalType: "SideValues", Doc: "prop: border-radius = rounding of the corners", Directives: gti.Directives{}, Tag: "xml:\"radius\" view:\"inline\""}},
		{"Color", &gti.Field{Name: "Color", Type: "goki.dev/girl/styles.SideColors", LocalType: "SideColors", Doc: "prop: border-color = color of the border", Directives: gti.Directives{}, Tag: "xml:\"color\" view:\"inline\""}},
	}),
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Transform", &gti.Field{Name: "Transform", Type: "goki.dev/mat32/v2.Mat2", LocalType: "mat32.Mat2", Doc: "prop: transform = our additions to transform -- pushed to render state", Directives: gti.Directives{}, Tag: "xml:\"transform\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Overflow", &gti.Field{Name: "Overflow", Type: "goki.dev/girl/styles.XY[goki.dev/girl/styles.Overflows]", LocalType: "XY[Overflows]", Doc: "Overflow determines how to handle overflowing content in a layout.\nDefault is OverflowVisible.  Set to OverflowAuto to enable scrollbars.", Directives: gti.Directives{}, Tag: ""}},
		{"Gap", &gti.Field{Name: "Gap", Type: "goki.dev/girl/units.XY", LocalType: "units.XY", Doc: "For layout, extra space added between elements in the layout.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		...
		{"Color", &gti.Field{Name: "Color", Type: "image/color.RGBA", LocalType: "color.RGBA", Doc: "Color specifies the text / content color, and it is inherited.", Directives: gti.Directives{}, Tag: "inherit:\"true\""}},
		{"BackgroundColor", &gti.Field{Name: "BackgroundColor", Type: "goki.dev/colors.Full", LocalType: "colors.Full", Doc: "BackgroundColor specifies the background color of the element. It is not inherited,\nand it is transparent by default.", Directives: gti.Directives{}, Tag: ""}},
		{"BackgroundImage", &gti.Field{Name: "BackgroundImage", Type: "io.Reader", LocalType: "io.Reader", Doc: "BackgroundImage, if non-nil, specifies an [io.Reader] to read a background image from using [image.Decode].\nIf it is specified, [Style.BackgroundColor] has no effect.", Directives: gti.Directives{}, Tag: ""}},
