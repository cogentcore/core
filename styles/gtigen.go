...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Justify", &gti.Field{Name: "Justify", Type: "goki.dev/girl/styles.s", LocalType: "Aligns", Doc: "Justify specifies the distribution of elements along the main axis,\ni.e., the same as Direction", Directives: gti.Directives{}, Tag: ""}},
		{"AlignItems", &gti.Field{Name: "AlignItems", Type: "goki.dev/girl/styles.s", LocalType: "Aligns", Doc: "AlignItems specifies the cross-axis alignment of child items within\nthis element, opposite to Direction.\nOnly for items within same Row or Column (see AlignContent).", Directives: gti.Directives{}, Tag: ""}},
		{"AlignSelf", &gti.Field{Name: "AlignSelf", Type: "goki.dev/girl/styles.s", LocalType: "Aligns", Doc: "AlignSelf specifies the cross-axis alignment of this item within\nits parent layout -- default of Auto means it uses parent AlignItems.", Directives: gti.Directives{}, Tag: ""}},
		{"AlignContent", &gti.Field{Name: "AlignContent", Type: "goki.dev/girl/styles.s", LocalType: "Aligns", Doc: "AlignContent specifies the cross-axis alignment between rows or columns\nwhen wrapped.  It has no effect if Wrap = false, or no wrapping occurs, and\nno effect for Display = Grid", Directives: gti.Directives{}, Tag: ""}},
