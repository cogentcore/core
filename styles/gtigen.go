...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Display", &gti.Field{Name: "Display", Type: "invalid type", LocalType: "Display", Doc: "Display controls how items are displayed, in terms of layout", Directives: gti.Directives{}, Tag: ""}},
