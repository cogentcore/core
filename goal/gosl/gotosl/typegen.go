...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/core/goal/gosl/gotosl.Function", IDName: "function", Doc: "Function represents the call graph of functions", Fields: []types.Field{{Name: "Name"}, {Name: "Funcs"}, {Name: "Atomics"}}})
...
var _ = types.AddFunc(&types.Func{Name: "cogentcore.org/core/goal/gosl/gotosl.NewFunction", Args: []string{"name"}, Returns: []string{"Function"}})

var _ = types.AddFunc(&types.Func{Name: "cogentcore.org/core/goal/gosl/gotosl.getAllFuncs", Args: []string{"f", "all"}})
...
var _ = types.AddFunc(&types.Func{Name: "cogentcore.org/core/goal/gosl/gotosl.SlRemoveComments", Args: []string{"lines"}, Returns: []string{"[][]byte"}})
