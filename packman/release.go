...
func VersionFileString(c *config.Config) (string, error) {
	...
	b.WriteString("const (\n")
	b.WriteString("\tVersion = \"" + c.Version + "\" // Version is the version of this package being used\n")
	...
	b.WriteString("\tVersionDate = \"" + date + "\" // VersionDate is the date-time of the release in UTC (in the format 'YYYY-MM-DD HH:MM', which is the Go format '2006-01-02 15:04')\n")
	b.WriteString(")\n\n")
	return b.String(), nil
}
