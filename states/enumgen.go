...
var _StatesNameToValueMap = map[string]States{`Invisible`: 0, `Disabled`: 1, `ReadOnly`: 2, `Selected`: 3, `Active`: 4, `Dragging`: 5, `Sliding`: 6, `Scrolling`: 7, `Focused`: 8, `Checked`: 9, `Indeterminate`: 10, `Hovered`: 11, `LongHovered`: 12, `LongPressed`: 13, `DragHovered`: 14, `DropOK`: 15, `Invalid`: 16, `Required`: 17, `Blank`: 18, `Link`: 19, `Visited`: 20, `AnyLink`: 21}
