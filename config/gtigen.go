...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Version", &gti.Field{Name: "Version", Type: "string", Doc: "the version of the project", Directives: gti.Directives{}}},
		{"Type", &gti.Field{Name: "Type", Type: "Types", Doc: "the type of the project (app/library)", Directives: gti.Directives{}}},
		{"Build", &gti.Field{Name: "Build", Type: "Build", Doc: "the configuration options for the build, install, and run commands", Directives: gti.Directives{}}},
		{"Setup", &gti.Field{Name: "Setup", Type: "Setup", Doc: "the configuration options for the setup command", Directives: gti.Directives{}}},
		{"Log", &gti.Field{Name: "Log", Type: "Log", Doc: "the configuration options for the log command", Directives: gti.Directives{}}},
		{"Release", &gti.Field{Name: "Release", Type: "Release", Doc: "the configuration options for the release command", Directives: gti.Directives{}}},
		{"Generate", &gti.Field{Name: "Generate", Type: "Generate", Doc: "the configuration options for the generate command", Directives: gti.Directives{}}},
	}),
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Package", &gti.Field{Name: "Package", Type: "string", Doc: "the path of the package to build", Directives: gti.Directives{}}},
		...
		{"IOSVersion", &gti.Field{Name: "IOSVersion", Type: "string", Doc: "the minimal version of the iOS SDK to compile against", Directives: gti.Directives{}}},
		{"AndroidMinSDK", &gti.Field{Name: "AndroidMinSDK", Type: "int", Doc: "the minimum supported Android SDK (uses-sdk/android:minSdkVersion in AndroidManifest.xml)", Directives: gti.Directives{}}},
		{"AndroidTargetSDK", &gti.Field{Name: "AndroidTargetSDK", Type: "int", Doc: "the target Android SDK version (uses-sdk/android:targetSdkVersion in AndroidManifest.xml)", Directives: gti.Directives{}}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Target", &gti.Field{Name: "Target", Type: "string", Doc: "the target platform to view the logs for (ios or android)", Directives: gti.Directives{}}},
		{"Keep", &gti.Field{Name: "Keep", Type: "bool", Doc: "whether to keep the previous log messages or clear them", Directives: gti.Directives{}}},
		{"All", &gti.Field{Name: "All", Type: "string", Doc: "messages not generated from your app equal to or above this log level will be shown", Directives: gti.Directives{}}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"VersionFile", &gti.Field{Name: "VersionFile", Type: "string", Doc: "the Go file to store version information in", Directives: gti.Directives{}}},
		{"Package", &gti.Field{Name: "Package", Type: "string", Doc: "the Go package in which the version file will be stored", Directives: gti.Directives{}}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Dir", &gti.Field{Name: "Dir", Type: "string", Doc: "the source directory to run generate on (can be multiple through ./...)", Directives: gti.Directives{}}},
		{"Output", &gti.Field{Name: "Output", Type: "string", Doc: "the output file location relative to the package on which generate is being called", Directives: gti.Directives{}}},
		{"AddKiTypes", &gti.Field{Name: "AddKiTypes", Type: "bool", Doc: "whether to automatically add all types that implement the ki.Ki interface (should be set to false in packages without Ki types)", Directives: gti.Directives{}}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
