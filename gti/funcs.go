...
var (
	...
	// key is long type name: package_url.Func, e.g., goki.dev/goki/gi.Button
...
// FuncByName returns a Func by name (package_url.Type, e.g., goki.dev/goki/gi.Button),
...
// FuncByNameTry returns a Func by name (package_url.Type, e.g., goki.dev/goki/gi.Button),
