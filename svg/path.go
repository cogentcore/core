...
func PathDataNextVec(data []PathData, i *int) math32.Vector2 {
	v := math32.Vector2{}
	v.X = float32(data[*i])
	(*i)++
	v.Y = float32(data[*i])
...
// For A: order is: nc, prv, rad, math32.Vector2{X: ang}, math32.V2(laf, sf)}
