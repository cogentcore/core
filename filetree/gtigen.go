...
var NodeType = types.AddType(&types.Type{Name: "cogentcore.org/core/filetree.Node", IDName: "node", Doc: "Node represents a file in the file system, as a TreeView node.\nThe name of the node is the name of the file.\nFolders have children containing further nodes.", Directives: []types.Directive{{Tool: "core", Directive: "embedder"}}, Methods: []types.Method{{Name: "OpenFilesDefault", Doc: "OpenFilesDefault opens selected files with default app for that file type (os defined).\nruns open on Mac, xdg-open on Linux, and start on Windows", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "DuplicateFiles", Doc: "DuplicateFiles makes a copy of selected files", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "DeleteFiles", Doc: "deletes any selected files or directories. If any directory is selected,\nall files and subdirectories in that directory are also deleted.", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "RenameFiles", Doc: "renames any selected files", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "RenameFile", Doc: "RenameFile renames file to new name", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"newpath"}, Returns: []string{"error"}}, {Name: "NewFiles", Doc: "NewFiles makes a new file in selected directory", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"filename", "addToVCS"}}, {Name: "NewFile", Doc: "NewFile makes a new file in this directory node", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"filename", "addToVCS"}}, {Name: "NewFolders", Doc: "makes a new folder in the given selected directory", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"foldername"}}, {Name: "NewFolder", Doc: "NewFolder makes a new folder (directory) in this directory node", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"foldername"}}, {Name: "ShowFileInfo", Doc: "Shows file information about selected file(s)", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "SortBys", Doc: "SortBys determines how to sort the selected files in the directory.\nDefault is alpha by name, optionally can be sorted by modification time.", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"modTime"}}, {Name: "OpenAll", Doc: "OpenAll opens all directories under this one", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "CloseAll", Doc: "CloseAll closes all directories under this one, this included", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "RemoveFromExterns", Doc: "RemoveFromExterns removes file from list of external files", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "AddToVCSSel", Doc: "AddToVCSSel adds selected files to version control system", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "DeleteFromVCSSel", Doc: "DeleteFromVCSSel removes selected files from version control system", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "CommitToVCSSel", Doc: "CommitToVCSSel commits to version control system based on last selected file", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "RevertVCSSel", Doc: "RevertVCSSel removes selected files from version control system", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}, {Name: "DiffVCSSel", Doc: "DiffVCSSel shows the diffs between two versions of selected files, given by the\nrevision specifiers -- if empty, defaults to A = current HEAD, B = current WC file.\n-1, -2 etc also work as universal ways of specifying prior revisions.\nDiffs are shown in a DiffViewDialog.", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"rev_a", "rev_b"}}, {Name: "LogVCSSel", Doc: "LogVCSSel shows the VCS log of commits for selected files, optionally with a\nsince date qualifier: If since is non-empty, it should be\na date-like expression that the VCS will understand, such as\n1/1/2020, yesterday, last year, etc.  SVN only understands a\nnumber as a maximum number of items to return.\nIf allFiles is true, then the log will show revisions for all files, not just\nthis one.\nReturns the Log and also shows it in a VCSLogView which supports further actions.", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}, Args: []string{"allFiles", "since"}}, {Name: "BlameVCSSel", Doc: "BlameVCSSel shows the VCS blame report for this file, reporting for each line\nthe revision and author of the last change.", Directives: []types.Directive{{Tool: "gti", Directive: "add"}}}}, Embeds: []types.Field{{Name: "TreeView"}}, Fields: []types.Field{{Name: "FPath", Doc: "full path to this file"}, {Name: "Info", Doc: "full standard file info about this file"}, {Name: "Buffer", Doc: "file buffer for editing this file"}, {Name: "FRoot", Doc: "root of the tree -- has global state"}, {Name: "DirRepo", Doc: "version control system repository for this directory,\nonly non-nil if this is the highest-level directory in the tree under vcs control"}, {Name: "RepoFiles", Doc: "version control system repository file status -- only valid during ReadDir"}}, Instance: &Node{}})
