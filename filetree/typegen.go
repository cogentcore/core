...
// NewNode adds a new [Node] to the given optional parent:
...
// NewVCSLogView adds a new [VCSLogView] to the given optional parent:
// VCSLogView is a view of the VCS log data
func NewVCSLogView(parent ...tree.Node) *VCSLogView {
	return tree.New[*VCSLogView](parent...)
}
