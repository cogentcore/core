...
var Hotspots = map[enums.Enum]image.Point{
	Arrow:               image.Pt(68, 17),
	ContextMenu:         image.Pt(37, 36),
	Help:                image.Pt(127, 127),
	Pointer:             image.Pt(88, 56),
	Progress:            image.Pt(69, 17),
	Wait:                image.Pt(132, 127),
	Cell:                image.Pt(125, 128),
	Crosshair:           image.Pt(128, 128),
	Text:                image.Pt(127, 132),
	VerticalText:        image.Pt(132, 127),
	Alias:               image.Pt(154, 70),
	Copy:                image.Pt(69, 17),
	Move:                image.Pt(128, 128), // TODO
	NotAllowed:          image.Pt(69, 17),
	Grab:                image.Pt(125, 84),
	Grabbing:            image.Pt(137, 124),
