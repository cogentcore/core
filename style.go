...
// get length rep from shiny -- need to have very late resolution of length units, during render
// so keep the units around and just call convert function -- also support dp
// don't use size2d -- just use Width Height etc separately
