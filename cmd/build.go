...
func init() {
	...
	buildCmd.PersistentFlags().StringSliceVar(&buildTarget, "target", []string{runtime.GOOS + "/" + runtime.GOARCH}, "the target platforms to build executables for, in os[/arch] format")
