...
var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/offscreen.App",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"TempDataDir", &gti.Field{Name: "TempDataDir", Type: "string", LocalType: "string", Doc: "TempDataDir is the path of the app data directory, used as the\nreturn value of [App.DataDir]. It is set to a temporary directory,\nas offscreen tests should not be dependent on user preferences and\nother data.", Directives: gti.Directives{}, Tag: ""}},
	}),
...
var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/offscreen.Window",
