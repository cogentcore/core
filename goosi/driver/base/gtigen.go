...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"EvMgr", &gti.Field{Name: "EvMgr", Type: "goki.dev/goosi/events.Mgr", LocalType: "events.Mgr", Doc: "EvMgr is the event manager for the app", Directives: gti.Directives{}, Tag: "label:\"Event manger\""}},
		...
		{"RendGeom", &gti.Field{Name: "RendGeom", Type: "goki.dev/mat32/v2.Geom2DInt", LocalType: "mat32.Geom2DInt", Doc: "RendGeom is the actual effective geometry of the window used\nfor rendering content.", Directives: gti.Directives{}, Tag: "label:\"Render geometry\""}},
	}),
	Embeds: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"App", &gti.Field{Name: "App", Type: "goki.dev/goosi/driver/base.App", LocalType: "App", Doc: "", Directives: gti.Directives{}, Tag: ""}},
	}),
