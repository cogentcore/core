...
var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/base.App",
	ShortName: "base.App",
	IDName:    "app",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"This", &gti.Field{Name: "This", Type: "goki.dev/goki/goosi.App", LocalType: "goosi.App", Doc: "This is the App as a [goosi.App] interface, which preserves the actual identity\nof the app when calling interface methods in the base App.", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		...
		{"MainQueue", &gti.Field{Name: "MainQueue", Type: "chan goki.dev/goki/goosi/driver/base.FuncRun", LocalType: "chan FuncRun", Doc: "MainQueue is the queue of functions to call on the main loop.\nTo add to it, use [App.RunOnMain].", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"MainDone", &gti.Field{Name: "MainDone", Type: "chan struct{}", LocalType: "chan struct{}", Doc: "MainDone is a channel on which is a signal is sent when the main\nloop of the app should be terminated.", Directives: gti.Directives{}, Tag: "view:\"-\""}},
...
var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/base.AppMulti",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Screens", &gti.Field{Name: "Screens", Type: "[]*goki.dev/goki/goosi.Screen", LocalType: "[]*goosi.Screen", Doc: "Screens are the screens associated with the app", Directives: gti.Directives{}, Tag: ""}},
		{"AllScreens", &gti.Field{Name: "AllScreens", Type: "[]*goki.dev/goki/goosi.Screen", LocalType: "[]*goosi.Screen", Doc: "AllScreens is a unique list of all screens ever seen, from which\ninformation can be got if something is missing in [AppMulti.Screens]", Directives: gti.Directives{}, Tag: ""}},
	...
	Embeds: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"App", &gti.Field{Name: "App", Type: "goki.dev/goki/goosi/driver/base.App", LocalType: "App", Doc: "", Directives: gti.Directives{}, Tag: ""}},
	}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})

var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/base.AppSingle",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"EvMgr", &gti.Field{Name: "EvMgr", Type: "goki.dev/goki/events.Mgr", LocalType: "events.Mgr", Doc: "EvMgr is the event manager for the app", Directives: gti.Directives{}, Tag: "label:\"Event manger\""}},
		{"Draw", &gti.Field{Name: "Draw", Type: "D", LocalType: "D", Doc: "Draw is the single [goosi.Drawer] used for the app.", Directives: gti.Directives{}, Tag: ""}},
		...
		{"Scrn", &gti.Field{Name: "Scrn", Type: "*goki.dev/goki/goosi.Screen", LocalType: "*goosi.Screen", Doc: "Scrn is the single [goosi.Screen] associated with the app.", Directives: gti.Directives{}, Tag: "label:\"Screen\""}},
		{"RendGeom", &gti.Field{Name: "RendGeom", Type: "goki.dev/goki/mat32.Geom2DInt", LocalType: "mat32.Geom2DInt", Doc: "RendGeom is the actual effective geometry of the window used\nfor rendering content.", Directives: gti.Directives{}, Tag: "label:\"Render geometry\""}},
	}),
	Embeds: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"App", &gti.Field{Name: "App", Type: "goki.dev/goki/goosi/driver/base.App", LocalType: "App", Doc: "", Directives: gti.Directives{}, Tag: ""}},
	}),
...
var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/base.Window",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"This", &gti.Field{Name: "This", Type: "goki.dev/goki/goosi.Window", LocalType: "goosi.Window", Doc: "This is the Window as a [goosi.Window] interface, which preserves the actual identity\nof the window when calling interface methods in the base Window.", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		...
		{"CloseReqFunc", &gti.Field{Name: "CloseReqFunc", Type: "func(win goki.dev/goki/goosi.Window)", LocalType: "func(win goosi.Window)", Doc: "CloseReqFunc is the function to call on a close request", Directives: gti.Directives{}, Tag: ""}},
		{"CloseCleanFunc", &gti.Field{Name: "CloseCleanFunc", Type: "func(win goki.dev/goki/goosi.Window)", LocalType: "func(win goosi.Window)", Doc: "CloseCleanFunc is the function to call to close the window", Directives: gti.Directives{}, Tag: ""}},
		...
		{"Flgs", &gti.Field{Name: "Flgs", Type: "goki.dev/goki/goosi.WindowFlags", LocalType: "goosi.WindowFlags", Doc: "Flgs contains the flags associated with the window", Directives: gti.Directives{}, Tag: "label:\"Flags\""}},
...
var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/base.WindowMulti",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"EvMgr", &gti.Field{Name: "EvMgr", Type: "goki.dev/goki/events.Mgr", LocalType: "events.Mgr", Doc: "EvMgr is the event manager for the window", Directives: gti.Directives{}, Tag: "label:\"Event manger\""}},
	...
	Embeds: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Window", &gti.Field{Name: "Window", Type: "goki.dev/goki/goosi/driver/base.Window", LocalType: "Window[A]", Doc: "", Directives: gti.Directives{}, Tag: ""}},
	}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})

var _ = gti.AddType(&gti.Type{
	Name:      "goki.dev/goki/goosi/driver/base.WindowSingle",
