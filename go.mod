...
require (
	...
	goki.dev/cam v0.9.17
	goki.dev/colors v0.8.12
	goki.dev/cursors v0.0.1
	goki.dev/enums v0.9.20
	goki.dev/girl v0.0.3
	goki.dev/glop v0.1.2
	goki.dev/goosi v0.0.0-20231011051544-b050fc8f1344
	goki.dev/grog v0.0.2
	goki.dev/grr v0.0.3
	goki.dev/gti v0.1.4
	goki.dev/icons v0.0.2
	goki.dev/ki/v2 v2.0.0-dev0.0.8
	goki.dev/laser v0.1.5
	goki.dev/mat32/v2 v2.0.0-dev0.0.6
	goki.dev/ordmap v0.5.5
	goki.dev/pi/v2 v2.0.0-dev0.0.2
	goki.dev/prof/v2 v2.0.0-dev0.0.4
	goki.dev/svg v0.1.4
	goki.dev/vci/v2 v2.0.0-dev0.0.5
