...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"X", &gti.Field{Name: "X", Type: "goki.dev/girl/units.Value", LocalType: "Value", Doc: "X is the horizontal axis value", Directives: gti.Directives{}, Tag: ""}},
		{"Y", &gti.Field{Name: "Y", Type: "goki.dev/girl/units.Value", LocalType: "Value", Doc: "Y is the vertical axis value", Directives: gti.Directives{}, Tag: ""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
