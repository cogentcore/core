...
var NodeType = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"NumLifetimeKids", &gti.Field{Name: "NumLifetimeKids", Type: "uint64", Doc: "the number of children that have ever been added to this node, which is used for unique naming", Directives: gti.Directives{}}},
